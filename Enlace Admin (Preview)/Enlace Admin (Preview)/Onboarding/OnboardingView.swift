        ...
        VStack(spacing: 20) {
            ...
            VStack(alignment: .leading, spacing: 15) {
                ...
                featureRow(icon: "chart.bar.fill", 
                          title: isSpanish ? "Analíticas" : "Analytics", 
                          description: isSpanish ? "Haga seguimiento de métricas de participación y compromiso" : "Track engagement and participation metrics")
            }
            .padding()

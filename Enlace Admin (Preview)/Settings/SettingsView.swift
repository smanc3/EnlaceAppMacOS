        ...
        NavigationView {
            List {
                ...
                Section(header: Text(isSpanish ? "Gestión de Consentimiento" : "Consent Management")) {
                    ...
                    .toggleStyle(SwitchToggleStyle(tint: .blue))
                    .onChange(of: consentManager.hasPrivacyConsent) { newValue in
                        NSLog("Privacy Policy consent changed to: \(newValue)")
                    }
                    ...
                    .toggleStyle(SwitchToggleStyle(tint: .blue))
                    .onChange(of: consentManager.hasTermsConsent) { newValue in
                        NSLog("Terms of Service consent changed to: \(newValue)")
                    }
